...
class Patient(models.Model):
    ...
    iin_num=models.CharField(max_length=13,unique=True)
...
class Medical_staff(models.Model):
    ...
    specialization_details_id=models.ForeignKey('Specialization_details',on_delete=models.CASCADE,default=1)
    experience=models.IntegerField()
...
class Department(models.Model):
    department_id=models.AutoField(default=1).primary_key
    name=models.CharField(max_length=30,unique=True,default='Dentistry')
